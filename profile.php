...
<div class="d-flex w-100 h-100">
	<div class="left-panel mt-2">
		<a href="index.php?page=profile" class="d-flex py-4 px-1 side-nav rounded">
			 <?php if(isset($_SESSION['login_profile_pic']) && !empty($_SESSION['login_profile_pic'])): ?>
              ...
              <?php endif; ?>
              <span class="ml-3" style="margin-top: -1px; font-size: 20px;"><b><?php echo ucwords($_SESSION['login_firstname'].' '.$_SESSION['login_lastname']) ?></b></span>
		</a>
		<a href="index.php?page=home" class="d-flex py-4 px-1 side-nav rounded">
	...
	<div class="container">
		<div class="col-lg-10 offset-md-1" style="height:60vh">
			<div class="position-relative image-fluid w-100 mb-1" style="height:65%">
				...
				<div class="w-100 d-flex justify-content-center position-absolute" style="top:65%">
					<span class="position-relative mt-5"">
			...
			<div class="d-block w-100 py-5 px-1 text-center">
				<h2 class="text-dark text-center" style="margin-top: 30px;"><b><?php echo ucwords($_SESSION['login_firstname'].' '.$_SESSION['login_lastname']); ?></b></h2>
